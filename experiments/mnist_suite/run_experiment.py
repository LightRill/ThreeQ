...
from experiments.mnist_suite.results_utils import write_summaries
from experiments.mnist_suite.suite_config import EXPERIMENT_NAME, param_space
from experiments.mnist_suite.trainable_def import trainable
...
RUNTIME_ENV = {
    "excludes": [
        ...
        "/experiments/mnist_suite/__pycache__/",
