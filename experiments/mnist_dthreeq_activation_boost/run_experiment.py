...
from experiments.mnist_dthreeq_activation_boost.suite_config import (
    EXPERIMENT_NAME,
    param_space,
)
from experiments.mnist_dthreeq_activation_boost.trainable_def import trainable
...
RUNTIME_ENV = {
    "excludes": [
        ...
        "/experiments/mnist_dthreeq_activation_boost/__pycache__/",
