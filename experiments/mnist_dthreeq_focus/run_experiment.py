...
from experiments.mnist_dthreeq_focus.suite_config import EXPERIMENT_NAME, param_space
from experiments.mnist_dthreeq_focus.trainable_def import trainable
...
RUNTIME_ENV = {
    "excludes": [
        ...
        "/experiments/mnist_dthreeq_focus/__pycache__/",
