...
from experiments.mnist_dthreeq_fullbudget_confirm.results_utils import (
    write_fullbudget_summaries,
)
from experiments.mnist_dthreeq_fullbudget_confirm.suite_config import (
    EXPERIMENT_NAME,
    param_space,
)
from experiments.mnist_dthreeq_fullbudget_confirm.trainable_def import trainable
...
RUNTIME_ENV = {
    "excludes": [
        ...
        "/experiments/mnist_dthreeq_fullbudget_confirm/__pycache__/",
        "/experiments/mnist_dthreeq_fullbudget_confirm/results/",
    ]
}
...
async def main() -> None:
    ...
    df = results["df"]
    write_fullbudget_summaries(df, SCRIPT_DIR / "results")
