...
最后更新：2026-04-19
当前状态：第一轮理论整理、最小可比较实验、DThreeQ 可行性筛查、DThreeQ 机制诊断、Dplus 修正诊断、MNIST 小预算压力筛查、legacy MNIST 复现实验、DThreeQ MNIST focused/longrun 筛查、EPThreeQ 调参、DThreeQ objective/activation/prediction audit、收敛性/发散性 LaTeX 报告、系统版学术报告与中期报告完善版已完成。
...
| 2026-04-19 | `1adc8a1` | 新增系统版 LaTeX 学术报告，整合 ThreeQ、EPThreeQ、DThreeQ、CNNThreeQ、收敛性、MNIST 实验和机制诊断 |
| 2026-04-19 | `ecb526f` | 基于用户上传的中期报告生成完善版 DOCX，补充 DThreeQ 改进过程、机制诊断、输入能量分析和后续计划 |
| 2026-04-19 | `137f125` | 按中期报告写作要求聚焦效果较好的实验路线，移除 CNN 相关内容，并将新增表格改为原报告样例风格 |
| 2026-04-19 | `7e3e0e0` | 基于用户二次修改版中期报告统一正式术语，将 ThreeQ 系列称谓替换为“预测性树突网络/Predictive Dendrites”，并压缩“存在的问题与困难”部分 |
| 2026-04-19 | this commit | 检查用户最新版中期报告正文空格、图题表题和明显格式问题，修复多余空白、截断图题和 bounded-gradient 拼写 |
